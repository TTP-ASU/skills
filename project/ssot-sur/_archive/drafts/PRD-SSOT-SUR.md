# PRD: Inventory Single Source of Truth for SUR (SUR SSOT)
...
**Product Development Requirements (Epics + Engineering Stories):** See [`docs/product-development-requirements.md`](../docs/product-development-requirements.md). That document contains Azure DevOps-ready Epics and User Stories with acceptance criteria. It evolves as architecture decisions are finalized; the PRD (this document) remains the stable product alignment reference.
