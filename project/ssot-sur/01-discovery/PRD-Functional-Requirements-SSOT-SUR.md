...
**Synced with TRD:** 2026-03-26 (post Strategy Discussion sync)
...
> **Architecture decisions completed (2026-03-19–25):** A1 · A4 · D1 · D2 · D3 · E2 · I2 resolved. **H6 resolved 2026-03-25:** UBIF Legacy not part of Q2 build — Q2 is UBIF Next-Gen only; Plan B for Legacy jobs in DAX TBD (last priority); C6 [ARCH] deferred. **Remaining [ARCH] for Q2 F-2 grooming:** A2 · D4 · I1 (combined API HLE sizing 2026-03-25). **I1 near resolution** — combined API design agreed 2026-03-25; formal clearance pending HLE. **A5** (Raghu/Amir job type nomenclature action item) to close. **Q1 F-1 is unblocked** — grooming can start immediately.
>
...
| D4 [ARCH] | Should reservation and JIT order creation be a single combined API call or separate calls? | DAX Arch | **Near resolution** | **BOM/API Contract Workshop 2026-03-25:** Prism confirmed it will only call the reservation API for parts that need to be reserved (separate from the availability call). JIT flag is a boolean in the availability response; JIT order creation generates a transfer order on the sales order. Direction = **separate calls**. Formal contract sign-off pending HLE completion. |
